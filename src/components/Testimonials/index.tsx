...
const testimonialData: Testimonial[] = [
  {
    ...
    designation: "CEO",
    content:
      "Private credit operator and builder focused on turning institutional expertise into scalable AI workflows.",
  ...
  },
  {
    ...
    designation: "CTO",
    content:
      "Technology leader bridging agentic systems, data architecture, and production-grade credit intelligence.",
  ...
  },
  {
    ...
    content:
      "Seasoned market advisor bringing decades of credit cycle insight and institutional perspective.",
