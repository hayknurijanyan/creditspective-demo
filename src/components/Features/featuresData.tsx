...
const featuresData: Feature[] = [
  {
    ...
    summary: "Find and prioritize the right opportunities.",
    details:
      "Early deal identification, platform-wide search across open, approved, closed, and done-away deals, and rapid screening and scoring against your investment criteria.",
    bullets: [
      "Early deal identification across your sourcing network",
      "Platform-wide search across open, approved, closed, and done-away deals",
      "Rapid screening and scoring against your investment criteria",
    ],
    eyebrow: "01 — Deal Discovery",
    imageSrc: "/images/stages/01.png",
    imageAlt:
      "CREDITspective deal analysis view for Precision Healthcare Solutions, showing pipeline, investment recommendation, and decision cards.",
  },
  {
    id: 2,
    anchor: "underwriting",
    ...
    title: "Underwriting",
    summary: "From data room to draft IC memo in minutes, not hours.",
    details:
      "Ingest data-room documents; AI agents extract and reconcile financials with source links; the platform auto-computes key metrics and surfaces areas for analyst focus; and it drafts credit analysis and IC memos in your firm's template, every figure traceable to its source.",
    bullets: [
      "Data-room ingestion with automated document classification",
      "Agents extract and reconcile financials with source links to every figure",
      "Auto-computed key metrics with analyst-focus areas surfaced",
      "Draft credit analysis and IC memos in your firm's template",
    ],
    eyebrow: "02 — Underwriting",
    imageSrc: "/images/stages/02.png",
    imageAlt:
      "CREDITspective underwriting workspace: Base Case Areas of Focus alongside Day-1 Financial Analysis for Warner Bros Discovery.",
  },
  {
    id: 3,
    anchor: "monitoring",
    ...
    title: "Monitoring",
    summary: "Move from reactive to proactive.",
    details:
      "Real-time covenant tracking, performance analysis, and early-warning alerts before issues escalate.",
    bullets: [
      "Real-time covenant tracking across the portfolio",
      "Performance analysis on financials, working capital, and YoY metrics",
      "Early-warning alerts before issues escalate",
    ],
    eyebrow: "03 — Monitoring",
    imageSrc: "/images/stages/03.png",
    imageAlt:
      "CREDITspective monitoring view: AI Adoption Review alongside Financial Monitor Covenant Analysis with real-time covenant tracking and trend direction.",
  },
  {
    id: 4,
    ...
    summary: "Turn hindsight into insight.",
    details:
      "Portfolio-level exposure tracking, cross-deal analysis, and continuous, alpha-oriented monitoring — all compounding on your institutional memory of funded, declined, and done-away deals. LP-ready reporting.",
    bullets: [
      "Portfolio-level exposure tracking and cross-deal analysis",
      "Continuous, alpha-oriented monitoring across the book",
      "Institutional memory of funded, declined, and done-away deals",
      "LP-ready reporting",
    ],
    eyebrow: "04 — Portfolio Management",
    imageSrc: "/images/stages/04.png",
    imageAlt:
      "CREDITspective portfolio management view: deal selection alongside total exposure, variance analysis, and portfolio insights.",
  },
];
