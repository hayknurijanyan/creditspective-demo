  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-8 border-b pb-8 text-base leading-relaxed dark:border-white/25">
        Beyond the Chat Window and the Point Tool explains why full-lifecycle,
        purpose-built AI creates durable advantages for credit investors.
      </p>
      <Link
        href="/#resources"
      ...
      <p className="text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
        Practical insights on workflow automation, data security, and
