    ...
    <section id="contact" className="overflow-hidden py-16 md:py-20 lg:py-28">
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              ...
              <p className="text-body-color mb-12 text-base font-medium">
                Book a walkthrough tailored to how your team sources,
                underwrites, and monitors credit.
              </p>
              <form>
                <div className="-mx-4 flex flex-wrap">
                  ...
                  <div className="w-full px-4">
                    <button className="shadow-submit dark:shadow-submit-dark bg-action hover:bg-action-hover rounded-xs px-9 py-4 text-base font-medium text-white duration-300">
                      Request a Demo
                    </button>
                  </div>
                </div>
          ...
          <div data-reveal="right" className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <NewsLatterBox />
          </div>
        </div>
      </div>
