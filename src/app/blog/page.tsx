...
export const metadata: Metadata = {
  title: "Resources | CREDITspective",
  description: "Blogs and research from CREDITspective.",
  // other metadata
};
...
const Blog = () => {
  return (
    <>
      <Breadcrumb
        pageName="Resources"
        description="Explore the latest CREDITspective blogs, research, and market intelligence insights."
      />
